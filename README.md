...
```
> [!NOTE]
> Sometimes, despite making these settings, you may not be able to access the service ports. You may need to delete the settings and make them again. This situation can happen frequently. You can use [this script](https://github.com/xNightwielder/manage-portproxy-script) for these like situations. This script creates a port proxy and security rule based on the ports you specify and the IP address you wish to redirect to. Through the same script, you can delete the port proxy and security rules you have created.
